    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            ...
            <div class="hidden md:flex items-center space-x-8">
                <a href="<?= BASE_URL ?>/dashboard/tourist/destinations.php" class="text-[#8B4513] hover:text-[#DAA520] transition-colors duration-200">
                    Destinations
                </a>
                <a href="<?= BASE_URL ?>/dashboard/tourist/top-guides.php" class="text-[#8B4513] hover:text-[#DAA520] transition-colors duration-200">
                    Guides
                </a>
            </div>
